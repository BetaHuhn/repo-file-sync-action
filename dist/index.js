...
module.exports = eval("require")("./git");
...
/* harmony import */ var _git__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(539);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(878);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(938);
...
async function run() {
	...
	const git = new _git__WEBPACK_IMPORTED_MODULE_2__()

	const repos = await (0,_config__WEBPACK_IMPORTED_MODULE_4__.parseConfig)()
		...
		try {
			...
			await (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.forEach)(item.files, async (file) => {
				...
				if (COMMIT_EACH_FILE === true) {
					...
					const useOriginalCommitMessage = ORIGINAL_MESSAGE && git.isOneCommitPush() && (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.arrayEquals)(await git.getChangesFromLastCommit(file.source), await git.changes(file.dest))
			...
			if (hasChanges === true) {
				...
				if (useOriginalCommitMessage) {
					await (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.forEach)(item.files, async (file) => {
						useOriginalCommitMessage = useOriginalCommitMessage && (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.arrayEquals)(await git.getChangesFromLastCommit(file.source), await git.changes(file.dest))
					})
				}
			...
			if (SKIP_PR === false) {
				...
				const changedFiles = (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.dedent)(`
					<details>
